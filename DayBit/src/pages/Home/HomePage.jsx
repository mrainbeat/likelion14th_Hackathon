...
function RewardBadge({ active }) {
  if (active) {
    return (
      <div className="flex size-[38px] shrink-0 items-center justify-center rounded-[4px] border-[1.5px] border-solid border-grey-60">
  ...
  return (
    <div className="flex size-[38px] shrink-0 items-center justify-center rounded-[4px] bg-grey-30">
      ...
      <div className="flex w-full flex-col items-center gap-[16px]">
              ...
              <div className="flex w-full items-center justify-between">
                ...
                >
                  <img
                    src={editIcon}
                    alt="일기 수정"
                    className="size-[26px] object-contain translate-y-[2px]"
                  />
                </button>
                <button
                  type="button"
        ...
        <div className="flex w-full flex-col items-start gap-[16px] rounded-[12px] bg-white px-[16px] py-[20px] shadow-[0_0_10px_0_rgba(77,80,91,0.05),0_0_30px_0_rgba(65,68,80,0.05)]">
          ...
          {[
            ...
            >
              <BubbleTail
                color={item.tone === "dark" ? "#858c9c" : "#e7e9ee"}
                className="!top-[-9px] !left-[-1.5px]"
              />
              <p
