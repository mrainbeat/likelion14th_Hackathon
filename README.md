...
DAYBIT은 이 셋을 각각 **작성 도움 질문과 성찰 질문**, **쌓일수록 다채로워지는 색과 주간 이미지**, **자신을 드러내지 않는 익명 경험 공유**로 해결하려 했다.
...
|            진입 시 타임스탬프가 자동으로 들어간다            |              내용 · 맥락 기반 작성 도움 질문을 받을 수 있다.              |       오늘 쓴 일기를 바탕으로 데이빗이 질문을 한다.         |
...
> 한 주의 일기가 모여 만들어진 주간 이미지. 아래 색들이 그 주에 모인 색이다.
